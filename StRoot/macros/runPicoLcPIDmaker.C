...
void runPicoLcPIDmaker(const Char_t *inputFile="test.list", const Char_t *outputFile="outputBaseName",
...
*/
  ...
  hfCuts->setHFTinputsOrPIDefficiency(1); //0 - HFT inputs; 1 - PID efficiency
  ...
  hfCuts->setCutSecondaryPairDcaToPvMax(0.5);
